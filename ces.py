...
url = r"http://dati.lzwuyou.com/WeChat/"
...
for i in range(20):  #共20题
    print("第%d题  正在盲猜" %(i+1))#range迭代器从0开始，所以i 加上1
    time.sleep(0.1)
    while True: #极致速度
        try:
    ...
    time.sleep(1.6)
    driver.get_screenshot_as_file(r"C:\Users\stone\Desktop\代码\python\图片\yes.png")
    #答题完毕立刻截图
    #我们用脚本答题后，网站懵逼，会一直叠加我们的答题时间
    driver.quit()
